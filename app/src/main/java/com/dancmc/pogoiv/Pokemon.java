...
public class Pokemon {
    ...
    /*6th gen pokemon base stats (Entered)
    private double mBaseHP;
    private double mBaseAtk;
    private double mBaseDef;
    private double mBaseSpAtk;
    private double mBaseSpDef;
    private double mBaseSpeed;
    */

    /*PoGo recalculated base + IV stats (not useful)
    private double mGoStamina;
    private double mGoAttack;
    private double mGoDefense;
    */
    ...
    //arrays of all pokemon stamina/atk/def, stardust amount to powerup at current level
    ...
    //array of all level CP multipliers
    ...
    public Pokemon(String pokemonName, int hp, int cp, int stardust, boolean freshMeat) {
        ...
        mPokemonNumber = getPokemonNumber(pokemonName);
    ...
    public double[] getPokemonStats(){
        double[] a = {mGoBaseStamina,mGoBaseAtk,mGoBaseDef};
        return a;
    }
